...
const BarraFiltrosSalidas = ({ filters, onFilterChange, onClear }) => {
    return (
        <div style={styles.filterBar}>
            ...
            <div style={{ ...styles.filterGroup, flexGrow: 1, minWidth: '200px' }}>
                ...
                <input
                    type="text"
                    placeholder="Ejem: Jabón azul, venta, cliente..."
            ...
            {/* Selector de Motivo de Salida */}
            <div style={styles.filterGroup}>
                <span style={styles.label}>Motivo de Salida</span>
                <select
                ...
                >
                    ...
                    <option value="MERMA">Merma/Daño ⚠️</option>
                </select>
            </div>

            {/* Selector de Periodo */}
            <div style={styles.filterGroup}>
                <span style={styles.label}>Periodo de Salida</span>
                <select
...
export default BarraFiltrosSalidas;
