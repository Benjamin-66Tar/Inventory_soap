...
const RecuperarPassword = () => {
  ...
  const [step, setStep] = useState(1); // 1 = pedir codigo, 2 = reestablecer
  ...
  const handleRequestCode = async (e) => {
    ...
    try {
      ...
      setMessage(response.data.message || 'Código enviado. Revisa los logs de la consola.');
      setStep(2);
    } catch (err) {
  ...
  return (
    <div style={pageStyle}>
      <div style={cardStyle}>
        ...
        <h1 style={titleStyle}>Recuperación</h1>
        <p style={subtitleStyle}>
          {step === 1 
            ? 'Ingresa tu correo para recibir un código de recuperación' 
            : 'Introduce el código enviado y tu nueva contraseña'}
        </p>
        ...
        {step === 1 ? (
          <form onSubmit={handleRequestCode} style={formStyle}>
